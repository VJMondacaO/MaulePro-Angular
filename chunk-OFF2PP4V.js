import{c as Q,e as E,g as N,i as O,ra as q,sa as g,ua as A,wa as P}from"./chunk-VOIOZGVW.js";import{$a as $,Bb as l,Cb as D,Db as F,Fb as f,Hb as m,Ib as y,La as o,Mb as j,N as v,Nb as S,O as h,T,Tb as z,Xa as b,Ya as C,ba as p,bb as r,ib as i,jc as B,lb as k,mb as I,sb as u,tb as d,ub as x,vb as M,wb as w}from"./chunk-TDMTREWI.js";var V=["icon"],H=["*"];function G(e,c){if(e&1&&x(0,"span",4),e&2){let t=l(2);i("ngClass",t.icon)}}function J(e,c){if(e&1&&(M(0),r(1,G,1,1,"span",3),w()),e&2){let t=l();o(),i("ngIf",t.icon)}}function K(e,c){}function L(e,c){e&1&&r(0,K,0,0,"ng-template")}function U(e,c){if(e&1&&(u(0,"span",5),r(1,L,1,0,null,6),d()),e&2){let t=l();o(),i("ngTemplateOutlet",t.iconTemplate||t._iconTemplate)}}var W=({dt:e})=>`
.p-tag {
    display: inline-flex;
    align-items: center;
