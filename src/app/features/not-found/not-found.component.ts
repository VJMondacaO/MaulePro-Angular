    ...
    template: `
        <div class="contenedor-404">
            <div class="contenido-404">
                ...
                <div class="texto-404">
                    <h1 class="titulo-404">Página No Encontrada</h1>
                    <p class="descripcion-404">Lo sentimos, no pudimos encontrar la página que buscas.</p>
                </div>
                <button 
                    pButton 
                    type="button"
